...
interface DockNavigationProps {
    currentPage: string;
    onNavigate: (page: 'landing' | 'leaderboard' | 'profile' | 'match' | 'pool-landing') => void;
            ...
            >
                ...
                <div className="relative">
                    ...
                    <button
                        ...
                        className={`p-3 rounded-full transition-all duration-300 relative group ${(isGameMenuOpen || (currentPage.endsWith('-landing') && currentPage !== 'landing'))
                ...
                <div className="relative">
                    ...
                    <button
                        ...
                        className={`p-3 rounded-full transition-all duration-300 relative group ${(isProfileMenuOpen || currentPage === 'profile')
                            ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/50'
                            : 'text-gray-400 hover:text-white hover:bg-white/10'
                            }`}
                        aria-label="Profile"
